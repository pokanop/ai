...
4. Update the statistics table in the Overview section — recompute it with the deterministic helper rather than adjusting counts by hand:
...
5. Update the phase header count (e.g. `Phase 1: Foundation (6/8 tasks complete)`) from the script's per-phase breakdown
